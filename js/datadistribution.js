...
$(document).ready(function() {
	...
	//and replace with this:
	  dataDist.init({
        server: "http://192.168.99.100", //Change this to your FME server name
        token: "5b3ab94532c003c5c16f4b512379599d9b6da299"     });  //Change this to your FME Server Token
	 // });
});
...
var dataDist = (function () {
  ...
  // privates
  var repository = 'Dashboards'; //To Customize: Change this to the repository where DataDownloadService.fmw was uploaded
